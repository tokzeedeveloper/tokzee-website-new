  ...
  return (
    <>
      <SEOHead
        ...
        description="How Tokzee App collects, uses, stores, and shares your personal information, and the choices you have about your data."
          ...
          <article className="max-w-4xl mx-auto px-6 lg:px-8">
            <div className="mb-8">
              ...
              <p className="text-base text-muted-foreground">
                ...
                offered through Tokzee App. Please read this Privacy Policy along with our{" "}
            ...
            <div className="prose prose-lg max-w-none">
              <section id="information-we-collect" className="mb-12">
                ...
                <p className="text-muted-foreground">
                  ...
                  legal requirements, and improve the Tokzee App. The table below outlines the categories of data we
              ...
              <section id="sharing" className="mb-12">
                ...
                <p className="text-muted-foreground">
                  ...
                  rights, safety, and property of Tokzee App, users, or the public.
                </p>
